<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        Welcome to Gulan Tower!
    </h1>

    <p class="mt-6 text-gray-500 leading-relaxed">
       we make what you dream.
    </p>
</div>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Gulan Tower include all kind of towers with heigh quality .
        </p>
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
           Gullan Tower have 25 floors for each towers.
        </p>

        <p class="mt-4 text-sm">
            <a href="/" class="inline-flex items-center font-semibold text-indigo-700">
                Start watching Floors
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
           Gulan Tower make (modern),(classic),(italy) all kind of desighn with very heigh quality we try for you .
        </p>
    </div>
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
           All of the appartments maked by very good staff .
        </p>
    </div>
</div>

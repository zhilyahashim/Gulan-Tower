...
.image_wrap{
   ...
   background-image: url(/images/d940db4c1c50ee97063be7a6f1424818.png);
...
.image_wrap1{
    ...
    left: 0%;
    transform: translateX(-50%) translateY(0%);
    background-image: url(/images/30bca21f42e1c976d9fc365559cb5b73.png);
    background-size: cover;
    background-position: 50% 58%;
    background-repeat: no-repeat;
}
.image_wrap2{
    ...
    left: 0%;
    transform: translateX(-50%) translateY(0%);
    background-image: url(/images/601727b319093cbf18a911e726253fb3.png);
    background-size: cover;
    background-position: 50% 58%;
    background-repeat: no-repeat;
}
...
<body>  
   <main>
        ...
        <div class="dull">
            <h1 class="big-name">Gulan <br>Furniture</h1>
            
        </div>
    <div class="moving">
        <div class="container py-4" >
            
            <div class="news-list" style="display: flex;  gap: 16px; justify-content: center;" >
                <article ><div class="new1" >
                    <img class="images" src="https://images.unsplash.com/photo-1534237710431-e2fc698436d0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YnVpbGRpbmd8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" alt=""
                     style=" border: none; border-radius: 8%;">
                    <h3>News 1</h3>
                    <p>Simple news descriptions</p></div>
                </article>
                <article><div class="new2">
                    <img class="images2" src="https://images.unsplash.com/photo-1494145904049-0dca59b4bbad?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YnVpbGRpbmd8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" alt=""
                     style=" border: none; border-radius: 8%;">
                    <h3>News 2</h3>
                    <p>Simple news descriptions</p></div>
                </article>
                <article><div class="new3">
                    <img class="images3" src="https://images.unsplash.com/photo-1554469384-e58fac16e23a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YnVpbGRpbmd8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60" alt="" 
                    style=" border: none; border-radius: 8%;">
                    <h3>News 3</h3>
                    <p>Simple news descriptions</p></div>
                </article>
        ...
        <div class="bottom-section hide ">
            <p><i class='bx bx-map'></i>Location in Erbil</p>

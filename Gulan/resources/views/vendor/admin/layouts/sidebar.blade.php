            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item @isActive([getRouteName().'.crud.lists', getRouteName().'.crud.create'], 'selected')">
                    <a class="sidebar-link @isActive([getRouteName().'.crud.lists', getRouteName().'.crud.create'], 'active') " href="@route(getRouteName().'.crud.lists')" aria-expanded="false">
                        ...
                        <span class="hide-menu">{{ __('Show-Lists') }}</span>
                    </a>
                </li>
                @endif
                ...
                <li class="sidebar-item @isActive(getRouteName().'.translation', 'selected')">
                    <a class="sidebar-link @isActive(getRouteName().'.translation', 'active') " href="@route('news.create')" aria-expanded="false">
                ...
                <li class="sidebar-item @isActive([getRouteName().'.role.lists', getRouteName().'.role.create', getRouteName().'.role.update'], 'selected')">
                    <a class="sidebar-link @isActive([getRouteName().'.role.lists', getRouteName().'.role.create', getRouteName().'.role.update'], 'active') " href="@route('news.Office')" aria-expanded="false">
                        <i data-feather="key" class="feather-icon"></i>
                        <span class="hide-menu">{{ __('Office&Residence') }}</span>
                    </a>
                </li>
                @endif
                  @if(hasPermission(getRouteName().'.role.lists', true))
                <li class="sidebar-item @isActive([getRouteName().'.role.lists', getRouteName().'.role.create', getRouteName().'.role.update'], 'selected')">
                    <a class="sidebar-link @isActive([getRouteName().'.role.lists', getRouteName().'.role.create', getRouteName().'.role.update'], 'active') " href="@route('news.Event')" aria-expanded="false">
                        <i data-feather="key" class="feather-icon"></i>
                        <span class="hide-menu">{{ __('Event') }}</span>
                    </a>
                </li>
                @endif

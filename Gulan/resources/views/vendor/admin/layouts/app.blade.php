...
<head>
    ...
    <title>{{ __('GullanTower') }} - {{ $title ?? __('Home') }}</title>
            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    <a href="@route(getRouteName().'.home')">
                        <span class="logo-text ">{{ __('GullanTower') }}</span>
                    </a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">
                                <span class="ml-2 d-none d-lg-inline-block"><span>{{ __('welcome') }},</span> <span
    ...
    <div class="page-wrapper ">
      <div class="container-fluid flex-initial">
        ...
        <div class="col-lg-4 mb-4 mb-lg-0">
            <img
            src="https://media.istockphoto.com/id/1135793300/photo/3d-rendering-of-corporate-buildings-with-sunlight.webp?b=1&s=170667a&w=0&k=20&c=lQnwWUmX8G_-0UQ4addPGXDS8Yay1MjZ9EHXaxgGvBY="
            class="w-100 shadow-1-strong rounded mb-4"
         ...
         <div class="col-lg-4 mb-4 mb-lg-0">
            <img
            src="https://media.istockphoto.com/id/1325342016/photo/mumbai-skyline-wadala-sewri-lalbaug.webp?b=1&s=170667a&w=0&k=20&c=PIdofESaOihcI_XFKRPjOrCAwj-6QIuZX84KxM6WDS4="
            class="w-100 shadow-1-strong rounded mb-4"
            alt="Yosemite National Park"
            />
        </div>
        ...
        <footer class="footer text-center text-muted ">GullanTower <a href="/"></a> Package.</footer>
